package com.run.treadmill.activity.runMode.hill;
...
@CreatePresenter(HillPresenter.class)
public class HillActivity extends BaseRunActivity<HillView, HillPresenter> implements HillView {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        lineChartView.setModeName(getString(R.string.string_mode_hill));
    }
    ...
    public void click(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_line_chart_speed:
                ...
                break;
            case R.id.btn_media:
                showMediaPopWin(CTConstant.HILL);
                break;
        }
    }
