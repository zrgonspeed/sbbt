...
public class UserProgramRunParamFloatWindow extends BaseRunParamFloatWindow {

    public UserProgramRunParamFloatWindow(Context context, WindowManager windowManager) {
