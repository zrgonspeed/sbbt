...
public class IntervalRunParamFloatWindow extends BaseRunParamFloatWindow {

    public IntervalRunParamFloatWindow(Context context, WindowManager windowManager) {
