 ...
 * @Time 2019/10/26
 */
@CreatePresenter(ProgramPresenter.class)
public class ProgramActivity extends BaseRunActivity<ProgramView, ProgramPresenter> implements ProgramView {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String modeName = getIntent().getStringExtra(CTConstant.PROGRAM_MODE_NAME);
        lineChartView.setModeName(modeName);
    }
    ...
    protected void showPopTip() {
        if (mRunningParam.runStatus == CTConstant.RUN_STATUS_STOP) {
            ...
            getPresenter().setInclineValue(0, -InitParam.MY_MIN_INCLINE, true);
        }
        super.showPopTip();
    }
