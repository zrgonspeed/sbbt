...
public class FitnessTestRunParamFloatWindow extends BaseRunParamFloatWindow {

    public FitnessTestRunParamFloatWindow(Context context, WindowManager windowManager) {
