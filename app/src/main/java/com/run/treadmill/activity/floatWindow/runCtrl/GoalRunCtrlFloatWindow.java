...
public class GoalRunCtrlFloatWindow extends BaseRunCtrlFloatWindow {
    ...
    public void dealLineChart() {
        if ((mfwm.mRunningParam.targetTime > 0 && mfwm.mRunningParam.targetTime <= mfwm.mRunningParam.alreadyRunTime)
                || (mfwm.mRunningParam.targetDistance > 0 && mfwm.mRunningParam.targetDistance <= mfwm.mRunningParam.alreadyRunDistance)
                || (mfwm.mRunningParam.targetCalories > 0 && mfwm.mRunningParam.targetCalories <= mfwm.mRunningParam.alreadyRunCalories)) {
        ...
        if (mfwm.mRunningParam.targetTime > 0) {
            mfwm.mRunningParam.setLcCurStageNum((int) (InitParam.TOTAL_RUN_STAGE_NUM * mfwm.mRunningParam.alreadyRunTime / mfwm.mRunningParam.targetTime));
        } else {
