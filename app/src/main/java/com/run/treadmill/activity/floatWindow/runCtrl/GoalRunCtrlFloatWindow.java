 ...
 * @Time 2019/06/17
 */
public class GoalRunCtrlFloatWindow extends BaseRunCtrlFloatWindow {

    public GoalRunCtrlFloatWindow(Context context, WindowManager windowManager) {
    ...
    public void dealLineChart() {
        if ((mFloatWindowManager.mRunningParam.targetTime > 0 && mFloatWindowManager.mRunningParam.targetTime <= mFloatWindowManager.mRunningParam.alreadyRunTime)
                || (mFloatWindowManager.mRunningParam.targetDistance > 0 && mFloatWindowManager.mRunningParam.targetDistance <= mFloatWindowManager.mRunningParam.alreadyRunDistance)
                || (mFloatWindowManager.mRunningParam.targetCalories > 0 && mFloatWindowManager.mRunningParam.targetCalories <= mFloatWindowManager.mRunningParam.alreadyRunCalories)) {
        ...
        if (mFloatWindowManager.mRunningParam.targetTime > 0) {
            mFloatWindowManager.mRunningParam.setLcCurStageNum((int) (InitParam.TOTAL_RUN_STAGE_NUM * mFloatWindowManager.mRunningParam.alreadyRunTime / mFloatWindowManager.mRunningParam.targetTime));
        } else {
