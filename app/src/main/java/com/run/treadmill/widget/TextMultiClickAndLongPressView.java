...
public class TextMultiClickAndLongPressView extends TextView {
    /**
     * 长度决定点击的次数
     */
    private long[] mHints;
    ...
    public TextMultiClickAndLongPressView(Context context) {
        super(context);
        init();
    }

    public TextMultiClickAndLongPressView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TextMultiClickAndLongPressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
