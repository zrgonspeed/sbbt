...
public class SerialKeyValue {
    ...
    public static final int BACK_KEY_LONG_1 = BACK_KEY_CLICK + 1;
    public static final int BACK_KEY_LONG_2 = BACK_KEY_CLICK + 2;
    ...
    private static boolean isResponseForOnce(int keyValue) {
        if (keyValue == START_CLICK
                ...
                || keyValue == QUICK_KEY_EVENT_SPEED_4_CLICK_LONG_1
                || keyValue == QUICK_KEY_EVENT_SPEED_4_CLICK_LONG_2
