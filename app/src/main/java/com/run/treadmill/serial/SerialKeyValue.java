...
public class SerialKeyValue {
    ...
    public static final int INCLINE_UP_CLICK = 0x28;
    public static final int INCLINE_UP_CLICK_LONG_1 = 0x29;
    public static final int INCLINE_UP_CLICK_LONG_2 = 0x2a;

    public static final int INCLINE_DOWN_CLICK = 0x2c;
    public static final int INCLINE_DOWN_CLICK_LONG_1 = 0x2d;
    public static final int INCLINE_DOWN_CLICK_LONG_2 = 0x2e;

    public static final int SPEED_UP_CLICK = 0x20;
    public static final int SPEED_UP_CLICK_LONG_1 = 0x21;
    public static final int SPEED_UP_CLICK_LONG_2 = 0x22;

    public static final int SPEED_DOWN_CLICK = 0x5c;
    public static final int SPEED_DOWN_CLICK_LONG_1 = 0x5d;
    public static final int SPEED_DOWN_CLICK_LONG_2 = 0x5e;

    public static final int QUICK_KEY_EVENT_INCLINE_2_CLICK = 0x38;
    public static final int QUICK_KEY_EVENT_INCLINE_2_CLICK_LONG_1 = 0x39;
    public static final int QUICK_KEY_EVENT_INCLINE_2_CLICK_LONG_2 = 0x3a;

    public static final int QUICK_KEY_EVENT_INCLINE_4_CLICK = 0x34;
    public static final int QUICK_KEY_EVENT_INCLINE_4_CLICK_LONG_1 = 0x35;
    public static final int QUICK_KEY_EVENT_INCLINE_4_CLICK_LONG_2 = 0x36;
    ...
    public static final int QUICK_KEY_EVENT_INCLINE_8_CLICK = 0x1c;
    public static final int QUICK_KEY_EVENT_INCLINE_8_CLICK_LONG_1 = 0x1d;
    public static final int QUICK_KEY_EVENT_INCLINE_8_CLICK_LONG_2 = 0x1e;

    public static final int QUICK_KEY_EVENT_INCLINE_12_CLICK = 0x18;
    public static final int QUICK_KEY_EVENT_INCLINE_12_CLICK_LONG_1 = 0x19;
    public static final int QUICK_KEY_EVENT_INCLINE_12_CLICK_LONG_2 = 0x1a;


    public static final int QUICK_KEY_EVENT_SPEED_3_CLICK = 0x3c;
    public static final int QUICK_KEY_EVENT_SPEED_3_CLICK_LONG_1 = 0x3d;
    public static final int QUICK_KEY_EVENT_SPEED_3_CLICK_LONG_2 = 0x3e;

    public static final int QUICK_KEY_EVENT_SPEED_6_CLICK = 0x30;
    public static final int QUICK_KEY_EVENT_SPEED_6_CLICK_LONG_1 = 0x31;
    public static final int QUICK_KEY_EVENT_SPEED_6_CLICK_LONG_2 = 0x32;
    ...
    public static final int QUICK_KEY_EVENT_SPEED_12_CLICK = 0x08;
    public static final int QUICK_KEY_EVENT_SPEED_12_CLICK_LONG_1 = 0x09;
    public static final int QUICK_KEY_EVENT_SPEED_12_CLICK_LONG_2 = 0x0a;

    public static final int QUICK_KEY_EVENT_SPEED_15_CLICK = 0x14;
    public static final int QUICK_KEY_EVENT_SPEED_15_CLICK_LONG_1 = 0x15;
    public static final int QUICK_KEY_EVENT_SPEED_15_CLICK_LONG_2 = 0x16;
    ...
    public static final int HOME_KEY_CLICK = 0x24;
    public static final int HOME_KEY_LONG_1 = 0x25;
    public static final int HOME_KEY_LONG_2 = 0x26;

    public static final int BACK_KEY_CLICK = 0x10;
    public static final int BACK_KEY_LONG_1 = 0x11;
    public static final int BACK_KEY_LONG_2 = 0x12;
